...
function katanimasi3() {
    ...
    const stringsArray = Array.from({ length: 10 }, (_, i) => {
        return `I will keep you smile I think ${i + 1}% ${shuffledEmojis[i]}`; // Mengambil emotikon dari array yang sudah diacak
    });
...
document.getElementById('loveIn').innerHTML = '<a href="#"><img src="assets/open-box.png" alt="HTML tutorial" style="width:42px;height:42px;"></a><p id="ket">Touch the LOVE!</p>';
